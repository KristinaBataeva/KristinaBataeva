...
### :hammer_and_wrench: Какими инструментами я владею?
  ...
  <b> tableau, yandex data lens, superset </b>
...
### :scroll: Дополнительное образование
  ...
  - Впервые с аналитикой данных я познакомилась в Karpov courses на курсе аналитики данных  
  - Курс симулятор аналитика, в котором фокус был на sql CH, git, airflow и визуализации, понимании продукта    
